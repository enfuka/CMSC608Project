...
const Reviews = () => {
  ...
  const Reviews = [
    [
      "AAdventurer",
      '"Had an amazing experience with Air608 today! The flight attendants were friendly and attentive, and the overall service was top-notch. #HappyTraveler"',
    ],
    [
      "TweetTraveller",
      "“Their impeccable service, comfortable seats, and friendly staff made my journey truly unforgettable. #Air608Fan”",
    ],
    [
      "CloudSurfer",
      '"Impressed with Air608 punctuality and smooth boarding process. No delays or hassles whatsoever. #EfficiencyWins"',
    ],

    [
      "FlyHighGuy",
      '"Thank you @Air608 for the smoothest flight ever! Your crew made the journey a delightful one. Cannot wait to fly with you again! #Air608 #HappyFlyer"',
    ],
    [
      "JetSetGo",
      '"Shoutout to @Air608 for the incredible in-flight entertainment options! The time flew by (literally) with all the movies and shows available. #Air608Experience"',
    ],
    [
      "SkyGazer",
      '"Landed safely and with a big smile on my face, thanks to @Air608s top-notch pilots! Kudos to the entire team for a job well done! #GratefulFlyer #Air608"',
    ],

    [
      "AirWander",
      '"Just experienced the tastiest in-flight meal ever, courtesy of @Air608s onboard catering. Highly recommend upgrading your meal! #Air608Cuisine"',
    ],
    [
      "AeroLark",
      '"Feeling refreshed and rejuvenated after my @Air608 flight. Their comfortable seats and ample legroom make all the difference during a long journey! #Air608Comfort"',
    ],
    [
      "TripAce",
      '"Major props to @Air608 for their excellent customer service. They went above and beyond to accommodate my needs, and Im beyond impressed! #Air608Cares"',
    ],

    [
      "OnAir89",
      '"Couldnt be happier with my @Air608 experience today. No hassles, no delays just a smooth and enjoyable journey. Thanks, Air608! #HappyTraveler"',
    ],
    [
      "FastFlyer",
      '"Just touched down after an incredible flight with @Air608. From check-in to touchdown, everything was flawless! #Air608Excellence #HappyFlyer"',
    ],
    [
      "WingZoom",
      '"Already looking forward to my next trip with @Air608! Theyve set the bar high with their exceptional service and attention to detail. #LoyalCustomer #Air608Love"',
    ],
  ];
